...
export default function Pictos() {
    ...
    return (
        <>
            ...
            <Link href="/lkw-partikelfilter/lkw-filterreinigung/direkter-draht-zur-filterreinigung" onMouseOver={() => setTogglePictoDirect(true)} onMouseOut={() => setTogglePictoDirect(false)}>
            ...
            <Link href={"/lkw-partikelfilter/lkw-filterreinigung"} onMouseOver={() =>{if (!togglePictoLos) setTogglePictoLos(true);} } onMouseOut={() => {if (togglePictoLos) setTogglePictoLos(false);}}>
            ...
            <Link href={"/lkw-partikelfilter/lkw-filterreinigung/ablauf-filterreinigung"} onMouseOver={() => setTogglePictoAblauf(true)} onMouseOut={() => setTogglePictoAblauf(false)}>
            ...
            <Link href={"/lkw-partikelfilter/lkw-filterreinigung/aus-und-einbau-deutschlandweit"} onMouseOver={() => setTogglePictoDeWeit(true)} onMouseOut={() => setTogglePictoDeWeit(false)}>
            ...
            <Link href={"/lkw-partikelfilter/lkw-filterreinigung/sofortabholung"} onMouseOver={() => setTogglePictoSofort(true)} onMouseOut={() => setTogglePictoSofort(false)}>
            ...
            <Link href={"/lkw-partikelfilter/lkw-filterreinigung/industriereinigung"} onMouseOver={() => setTogglePictoIndustrie(true)} onMouseOut={() => setTogglePictoIndustrie(false)}>
            ...
            <Link href={"/lkw-partikelfilter/lkw-filterreinigung/express-service"} onMouseOver={() => setTogglePictoExpress(true)} onMouseOut={() => setTogglePictoExpress(false)}>
            ...
            <Link href={"/lkw-partikelfilter/lkw-filterreinigung/fragenkatalog"} onMouseOver={() => setTogglePictoFragen(true)} onMouseOut={() => setTogglePictoFragen(false)}>
            ...
            <Link href={"/lkw-partikelfilter/lkw-filterreinigung/anfrage-haendlerpreis"} onMouseOver={() => setTogglePictoHaendler(true)} onMouseOut={() => setTogglePictoHaendler(false)}>
