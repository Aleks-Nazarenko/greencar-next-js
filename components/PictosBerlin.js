...
export default function Pictos() {
    ...
    return (
        <>
            ...
            <Link href="/pkw-partikelfilter/filterreinigung-berlin/direkter-draht-zur-filterreinigung" onMouseOver={() => setTogglePictoDirect(true)} onMouseOut={() => setTogglePictoDirect(false)}>
            ...
            <Link href={"/pkw-partikelfilter/filterreinigung-berlin"} onMouseOver={() =>{if (!togglePictoLos) setTogglePictoLos(true);} } onMouseOut={() => {if (togglePictoLos) setTogglePictoLos(false);}}>
            ...
            <Link href={"/pkw-partikelfilter/filterreinigung-berlin/ablauf-filterreinigung"} onMouseOver={() => setTogglePictoAblauf(true)} onMouseOut={() => setTogglePictoAblauf(false)}>
            ...
            <Link href={"/pkw-partikelfilter/filterreinigung-berlin/aus-und-einbau-deutschlandweit"} onMouseOver={() => setTogglePictoDeWeit(true)} onMouseOut={() => setTogglePictoDeWeit(false)}>
            ...
            <Link href={"/pkw-partikelfilter/filterreinigung-berlin/sofortabholung"} onMouseOver={() => setTogglePictoSofort(true)} onMouseOut={() => setTogglePictoSofort(false)}>
                <Image src={togglePictoSofort ? "/images/pictos/rein_pikt_sofortabholung_b_over.png" : "/images/pictos/rein_pikt_sofortabholung_b.png"} alt={"Sofortabholung"} width={331} height={120} className={"img-fluid ps-0 ps-sm-2 picto-product "} />
            </Link>
            <Link href={"/pkw-partikelfilter/filterreinigung-berlin/industriereinigung"} onMouseOver={() => setTogglePictoIndustrie(true)} onMouseOut={() => setTogglePictoIndustrie(false)}>
            ...
            <Link href={"/pkw-partikelfilter/filterreinigung-berlin/express-service"} onMouseOver={() => setTogglePictoExpress(true)} onMouseOut={() => setTogglePictoExpress(false)}>
                <Image src={togglePictoExpress ? "/images/pictos/rein_pikt_express_b_over.png" : "/images/pictos/rein_pikt_express_b.png"} alt={"Express-Service"} width={331} height={120} className={"img-fluid ps-0 ps-sm-2 picto-product "} />
            </Link>
            ...
            <Link href={"/pkw-partikelfilter/filterreinigung-berlin/fragenkatalog"} onMouseOver={() => setTogglePictoFragen(true)} onMouseOut={() => setTogglePictoFragen(false)}>
            ...
            <Link href={"/pkw-partikelfilter/filterreinigung-berlin/anfrage-haendlerpreis"} onMouseOver={() => setTogglePictoHaendler(true)} onMouseOut={() => setTogglePictoHaendler(false)}>
