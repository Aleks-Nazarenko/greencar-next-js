                ...
                <div className="dropdown-container row g-0 justify-content-sm-between justify-content-start">
                    <Dropdown className={"col-auto pe-sm-0 pe-2 pb-2 pb-sm-0 "}>
                        ...
                        <Dropdown.Menu className={"shadow rounded-4 mt-2"}>
                            ...
                            <Dropdown.Item href="/pkw-partikelfilter/pkw-austauschfilter" className="d-flex align-items-center pe-2 ps-2">
                                <Image src="/images/icons/pkw-austauschfilter.png" alt="PKW Austauschfilter" width={50} height={50} className="me-2 picto-50" />
                                Austauschfilter
                            </Dropdown.Item>
                            <Dropdown.Item href="/pkw-partikelfilter/pkw-filterreinigung" className="d-flex align-items-center pe-2 ps-2">
                                <Image src="/images/icons/pkw-filterreinigung.png" alt="PKW filterreinigung" width={50} height={50} className="me-2 picto-50" />
                                Filterreinigung
                            </Dropdown.Item>
                            <Dropdown.Item href="/pkw-partikelfilter/filterreinigung-berlin" className="d-flex align-items-center pe-2 ps-2">
                    ...
                    <Dropdown className={"col-auto pe-sm-0 pe-2 pb-2 pb-sm-0 "}>
                        ...
                        <Dropdown.Menu  className={"shadow rounded-4 mt-2"}>
                            ...
                            <Dropdown.Item href="/lkw-partikelfilter/schalldaempfer-euro-vi" className="d-flex align-items-center pe-2 ps-2">
                            ...
                            <Dropdown.Item href="/lkw-partikelfilter/lkw-filterreinigung" className="d-flex align-items-center pe-2 ps-2">
                    ...
                    <Dropdown className={"col-auto pe-sm-0 pe-2 pb-2 pb-sm-0 "}>
                        ...
                        {/* 🔹 Dropdown Menu */}
                        <Dropdown.Menu  className={"shadow rounded-4 mt-2"}>
                            <Dropdown.Item href="/bus-partikelfilter/dpf-euro-vi" className="d-flex align-items-center pe-2 ps-2">
                                <Image src="/images/icons/bus-austauschfilter.png" alt="BUS DPF EURO VI" width={50} height={50} className="me-2 picto-50" />
                                DPF EURO VI
                            </Dropdown.Item>
                            <Dropdown.Item href="/bus-partikelfilter/bus-filterreinigung" className="d-flex align-items-center pe-2 ps-2">
                    ...
                    <Dropdown className={"col-auto pe-sm-0 pe-2 pb-2 pb-sm-0 "}>
                        ...
                        {/* 🔹 Dropdown Menu */}
                        <Dropdown.Menu  className={"shadow rounded-4 mt-2"}>
                            <Dropdown.Item href="/baumaschinen-partikelfilter/baumaschinen-nachruestfilter" className="d-flex align-items-center pe-2 ps-2">
                            ...
                            <Dropdown.Item href="/baumaschinen-partikelfilter/baumaschinen-filterreinigung" className="d-flex align-items-center pe-2 ps-2">
                    ...
                    <Dropdown className={"col-auto pe-sm-0 pe-2 pb-2 pb-sm-0 "}>
                        ...
                        {/* 🔹 Dropdown Menu */}
                        <Dropdown.Menu  className={"shadow rounded-4 mt-2"}>
                            <Dropdown.Item href="/partikelfilter-reinigen" className="d-flex align-items-center pe-2 ps-2">
                                <Image src="/images/icons/filterreinigung-partikelfilter.png" alt="Reinigung" width={50} height={50} className="me-2 picto-50" />
                                Reiningung
                            </Dropdown.Item>
                        </Dropdown.Menu>
